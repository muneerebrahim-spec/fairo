...
enum AppSettings {
    ...
    /// User-chosen default, seeded from the device locale on first launch.
    ...
    static var usesLocaleDefault: Bool {
        preferredCurrencyCode == localeDefaultCurrencyCode
    }

    static func resetCurrencyToLocaleDefault() {
        preferredCurrencyCode = localeDefaultCurrencyCode
    }
